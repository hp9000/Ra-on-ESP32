...
void MAILBOX_IRQHandler (uint32_t requests)
{
   ...
   // ESP_LOGE("HP","MAILBOX IRQ: 0x%08X", requests);
...
void main2 (void)
{
    static const SYNC_Config *syncConfig = NULL;
    SYNC_Handle sync;
...
//        ESP_LOGE("HP", "newMode = %d,currentMode = %d",newMode,currentMode);
