...
extern void MAILBOX_IRQHandler_SYS (LPC_MAILBOX_t* LPC_MAILBOX);
LPC_MAILBOX_t LPC_MAILBOX_Instance;
LPC_MAILBOX_t* LPC_MAILBOX = &LPC_MAILBOX_Instance;
...
void PIN_INT3_IRQHandler2 (unsigned int bit)
{
 ...
 //ESP_LOGE("HP","packet received!!!");
                    ...
                    MAILBOX_IRQHandler_SYS(LPC_MAILBOX);
                }
