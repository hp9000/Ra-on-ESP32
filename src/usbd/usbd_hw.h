/***********************************************************************
 * $Id: usbd_hw.h 6952 2011-03-23 22:26:42Z usb10131 $
 *
 * Project: USB device ROM stack
 *
 * Description: Hardware API structure definitions.
 *
...
typedef struct USBD_HW_API
{
   ...
   */
  uint32_t (*GetMemSize)(const USBD_API_INIT_PARAM_T* param);
   ...
   */
  ErrorCode_t (*Init)(USBD_HANDLE_T* phUsb, USB_CORE_DESCS_T* pDesc, const USBD_API_INIT_PARAM_T* param);
