...
#define CDC_HEADER_DESC_SIZE                        (sizeof(CDC_HEADER_DESCRIPTOR))
#define CDC_CALL_MANAGEMENT_DESC_SIZE               (sizeof(CDC_CALL_MANAGEMENT_DESCRIPTOR))
#define CDC_ABSTRACT_CONTROL_MANAGEMENT_DESC_SIZE   (sizeof(CDC_ABSTRACT_CONTROL_MANAGEMENT_DESCRIPTOR))
#define CDC_UNION_DESC_SIZE                         (sizeof(CDC_UNION_DESCRIPTOR))
