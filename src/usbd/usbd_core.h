/***********************************************************************
 * $Id: usbd_core.h 7348 2011-05-10 23:30:39Z usb10131 $
 *
 * Project: USB device ROM stack
 *
 * Description: USB Core API structure definitions.
 *
...
/* inline functions */
__inline DQH_T* USB_GetEpQH(USB_CORE_CTRL_T* pCtrl, uint8_t ep)
{
    DQH_T* ep_QH = (DQH_T*)(*((uint32_t*)pCtrl->hw_data));
